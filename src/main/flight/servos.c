...
static const servoMixer_t servoMixerQuadTilt[] = {
    ...
    { SERVO_QUAD_TILT_1, INPUT_RC_ROLL,    QUAD_SERVO_RATE_ROLL, 0, 0, 100, 0 },
    { SERVO_QUAD_TILT_2, INPUT_RC_ROLL,   -QUAD_SERVO_RATE_ROLL, 0, 0, 100, 0 },
    { SERVO_QUAD_TILT_3, INPUT_RC_ROLL,    QUAD_SERVO_RATE_ROLL, 0, 0, 100, 0 },
    { SERVO_QUAD_TILT_4, INPUT_RC_ROLL,   -QUAD_SERVO_RATE_ROLL, 0, 0, 100, 0 },
    { SERVO_QUAD_TILT_1, INPUT_RC_PITCH,  QUAD_SERVO_RATE_PITCH, 0, 0, 100, 0 },
    { SERVO_QUAD_TILT_2, INPUT_RC_PITCH,  QUAD_SERVO_RATE_PITCH, 0, 0, 100, 0 },
    { SERVO_QUAD_TILT_3, INPUT_RC_PITCH,   -QUAD_SERVO_RATE_PITCH, 0, 0, 100, 0 },
    { SERVO_QUAD_TILT_4, INPUT_RC_PITCH,   -QUAD_SERVO_RATE_PITCH, 0, 0, 100, 0 },
};
